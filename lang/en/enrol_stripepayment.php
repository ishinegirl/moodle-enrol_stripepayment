...
$string['checkoutpic']='Checkout page image';
$string['checkoutpic_desc'] = 'A square image of your brand to be displayed in the checkout popup. Stripe recommends you set one. The minimum size is 128x128';
$string['termsexplanation']='I have read and agree to the <a class="enrol_stripepayment_termslink" href="{$a}" target="_blank">Terms and Conditions</a>';